...
class FGJumperMaster():
    ...
    def cal_shadow_mask(self):
        ...
        self.shd_mask = cv2.morphologyEx(self.shd_mask, cv2.MORPH_CLOSE, kernel)  
    ...
    def cal_box_mask(self):
        ...
        self.box_mask = cv2.morphologyEx(self.box_mask, cv2.MORPH_CLOSE, kernel) 
    ...
    def cal_chs_mask(self):
        '''
           计算棋子的罩层, 颜色阈值是提前设定好的. 
        '''
        self.chs_mask = cv2.inRange(self.img_nobg, self.chs_lcolor, self.chs_ucolor)
